...
```bash
git remote add encore encore://war-room-backend-a6ui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/war-room-backend-a6ui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/war-room-backend-a6ui/settings/integrations/github)
